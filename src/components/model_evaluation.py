...
from src.entity.artifact_entity import ModelTrainigArtifact, DataIngestionArtifact, ModelEvaluationArtifact
...
class ModelEvaluation:
    ...
    def evaluate_model(self) -> EvaluateModelResponse:
        ...
        try:
            ...
            trained_model = load_object(file_path=self.model_trainer_artifact.train_model_file_path)
            ...
            result = EvaluateModelResponse(train_model_f1_score=trained_model_f1_score,
    ...
    def initiate_model_evaluation(self) -> ModelEvaluationArtifact:
        ...
        try:
            ...
            model_evaluation_artifact = ModelEvaluationArtifact(
                is_model_acceptable=evaluate_model_response.is_model_accepted,
                s3_model_path=s3_model_path,
                trained_model_path=self.model_trainer_artifact.train_model_file_path,
